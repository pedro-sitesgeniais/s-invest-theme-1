        ...
        <?php if (empty($investimento_ids)) : ?>
            <div class="bg-gray-50 rounded-lg p-8 text-center">
                <svg class="animate-spin h-6 w-6 text-blue-500 mx-auto mb-2" fill="none" viewBox="0 0 24 24">
                    ...
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 0 1 8-8V0C5.373 0 0 5.373 0 12h4 zm2 5.291 A7.962 7.962 0 0,1 4,12 H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
                </svg>
